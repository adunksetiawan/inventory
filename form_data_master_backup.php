...
<?php } elseif($_GET['kode']=="kategori_insert"){
		//pemanggilan fungsi penambahan
		$a="SELECT * FROM barang_kategori";
		$b="SELECT id_kat FROM barang_kategori ORDER BY id_kat DESC LIMIT 1";
		$inc=penambahan($a, $b); ?>
...
<div class="col-lg-12">
        ...
        <table border="0" cellspacing="2" cellpadding="0" width="100%">
          <tr>
            ...
            <td>:</td>
            <td><label>
              <input name="kode_kat" type="text" id="input" placeholder="Kode Kategori" class="form-control" size="70" maxlength="100" />
            </label></td>
          </tr>
          <tr>
            <td>Nama Kategori</td>
            <td>:</td>
            <td><label>
              <input name="nm_kat" type="text" id="input" class="form-control" placeholder="Nama Kategori" size="70" maxlength="70" />
            </label></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
